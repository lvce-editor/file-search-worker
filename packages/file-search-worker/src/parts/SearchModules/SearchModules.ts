...
export const searchModules: Record<string, SearchFileHandler> = {
  [FileSystemProtocol.Default]: SearchFileRipGrep.searchFile,
  [FileSystemProtocol.Fetch]: SearchFileFetch.searchFile,
  [FileSystemProtocol.File]: SearchFileRipGrep.searchFile,
